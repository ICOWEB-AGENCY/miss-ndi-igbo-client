  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 24 }}>
        ...
        <div>
          Votes:{" "}
          <span style={{ fontWeight: "700", color: constants.colors.primary1 }}>
            {contestant.votes}{" "}
          </span>
        </div>
        <div
        ...
        >
          ...
          <Link
            href={
              action === "Vote"
                ? `/vote-contestant?id=${contestant.contestantId}&contestant=${contestant.username}`
                : `/manage-users?user=${contestant.contestantId}`
            }
          >
            <a
              onClick={setValues}
