...
export default   function Profile({theUser={}}) {
  ...
  const [showMenu,setShowMenu]=useState(false)
   ...
   const category= [{item:"Profile",img:"user"},{item:"Votes",img:"menu"},{item:"Account Settings",img:"settings"}]
    return (
        <main>
        <header style={{padding:"16px 94px"}}
...
style={{marginRight:75,display:"flex",alignItems:"center",cursor:"pointer",position:"relative"}}>
   ...
   <img src={`./images/profile-${menuItem.img}.svg`}  style={{marginRight:17}}/>
        ...
        </span>
      {
        ...
        {
          showMenu &&   <nav style={{position:"absolute",backgroundColor:"#fff",zIndex:5,right:0,top:60,padding:8,borderRadius:"10px 0px 0px 10px",boxShadow:"5px 5px 7px #f2f3f2"}}>
          <ul>
{
   category.map(menuItem=>{
            return (
<li 
onClick={()=>{setActive(menuItem.item);setShowMenu(false)}}
style={{marginRight:75,display:"flex",alignItems:"center",cursor:"pointer",position:"relative",marginBottom:10}}>
...
<li 
onClick={()=>{setActive("mobile-profile");setShowMenu(false)}}
style={{marginRight:10,display:"flex",alignItems:"center",cursor:"pointer",position:"relative"}}>
...
style={{marginRight:10,display:"flex",alignItems:"center",cursor:"pointer",position:"relative"}}>
   ...
   <img src={`./images/profile-menu.svg`}
     style={{marginRight:0}}/>
...
{
    active==="mobile-profile" && <div className={styles.mobileProfile}>
<Main 
user={user}
setUser={setUser}
/>
